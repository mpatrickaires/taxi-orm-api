...
namespace TaxiOrmApi.Migrations
{
    ...
    [Migration("20220529191858_SolicitacaoEntity")]
    partial class SolicitacaoEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxiOrmApi.Models.SolicitacaoModel.Solicitacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("LocalizacaoDestinoId")
                        .HasColumnType("integer")
                        .HasColumnName("localizacao_destino_id");

                    b.Property<int>("LocalizacaoOrigemId")
                        .HasColumnType("integer")
                        .HasColumnName("localizacao_origem_id");
                    ...
                    b.HasIndex("ClienteId")
                        .HasDatabaseName("ix_solicitacao_cliente_id");

                    b.HasIndex("LocalizacaoDestinoId")
                        .HasDatabaseName("ix_solicitacao_localizacao_destino_id");

                    b.HasIndex("LocalizacaoOrigemId")
                        .HasDatabaseName("ix_solicitacao_localizacao_origem_id");

                    b.HasIndex("MotoristaId")
                        .HasDatabaseName("ix_solicitacao_motorista_id");
            ...
            modelBuilder.Entity("TaxiOrmApi.Models.SolicitacaoModel.Solicitacao", b =>
                {
                    b.HasOne("TaxiOrmApi.Models.ClienteModel.Cliente", "Cliente")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_solicitacao_cliente_cliente_id");

                    b.HasOne("TaxiOrmApi.Models.LocalizacaoModel.Localizacao", "LocalizacaoDestino")
                        .WithMany("SolicitacoesDestino")
                        .HasForeignKey("LocalizacaoDestinoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_solicitacao_localizacao_localizacao_destino_id");

                    b.HasOne("TaxiOrmApi.Models.LocalizacaoModel.Localizacao", "LocalizacaoOrigem")
                        .WithMany("SolicitacoesOrigem")
                        .HasForeignKey("LocalizacaoOrigemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_solicitacao_localizacao_localizacao_origem_id");

                    b.HasOne("TaxiOrmApi.Models.MotoristaModel.Motorista", "Motorista")
                        .WithMany("Solicitacoes")
                        .HasForeignKey("MotoristaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_solicitacao_motorista_motorista_id");

                    b.Navigation("Cliente");

                    b.Navigation("LocalizacaoDestino");

                    b.Navigation("LocalizacaoOrigem");
            ...
            modelBuilder.Entity("TaxiOrmApi.Models.LocalizacaoModel.Localizacao", b =>
                {
                    b.Navigation("SolicitacoesDestino");

                    b.Navigation("SolicitacoesOrigem");
                });
